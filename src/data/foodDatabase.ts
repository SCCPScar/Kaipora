...
const CURATED_DATABASE: FoodDatabaseItem[] = [
  ...
  { id: 'fd_peru_fumado', label: 'Peru defumado', kcal: 105, protein: 18, carbs: 2.0, fat: 3.0 },
  ...
  { id: 'fd_leite_meio_gordo', label: 'Leite semidesnatado', kcal: 46, protein: 3.4, carbs: 4.9, fat: 1.6 },
  ...
  { id: 'fd_brocolos', label: 'Brócolis cozidos', kcal: 35, protein: 2.4, carbs: 7.0, fat: 0.4 },
  { id: 'fd_espinafres', label: 'Espinafre', kcal: 23, protein: 2.9, carbs: 3.6, fat: 0.4 },
  ...
  { id: 'fd_bolacha_maria', label: 'Biscoito Maria', kcal: 440, protein: 7.0, carbs: 75, fat: 12 },
  ...
  { id: 'fd_sumo_laranja', label: 'Suco de laranja natural', kcal: 45, protein: 0.7, carbs: 10, fat: 0.2 },

  // Mais proteínas.
  { id: 'fd_peru_peito', label: 'Peito de peru grelhado', kcal: 135, protein: 29, carbs: 0, fat: 1.7 },
  { id: 'fd_coelho', label: 'Coelho guisado', kcal: 173, protein: 21, carbs: 0, fat: 9.0 },
  ...
  { id: 'fd_meloa', label: 'Melão', kcal: 34, protein: 0.8, carbs: 8.2, fat: 0.2 },
  ...
  { id: 'fd_ananas', label: 'Abacaxi', kcal: 50, protein: 0.5, carbs: 13, fat: 0.1 },
  { id: 'fd_manga', label: 'Manga', kcal: 60, protein: 0.8, carbs: 15, fat: 0.4 },
  { id: 'fd_feijao_verde', label: 'Vagem cozida', kcal: 31, protein: 1.8, carbs: 7.0, fat: 0.2 },
