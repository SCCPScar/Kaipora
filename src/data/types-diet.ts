...
export const DIET_NOTES = [
  ...
  'Não beba durante as refeições (cerca de 30 min antes e depois), recomendação comum pós-bariátrica.',
  'Mastigue devagar e pare quando sentir saciedade. O app registra o que comeu, não obriga a terminar o prato.',
  'Todas as opções de uma refeição são substituições equivalentes entre si. Escolha a que tiver disponível.',
  ...
  'O Diário Livre e o Contador de Calorias usam a mesma lógica de estimativas de referência (por 100g), úteis para ter uma noção geral, não para precisão clínica.'
];
